...
//console.log(wordHistoryLinked, listSuggestionsLinked) for searched values
//console.log(imageplease) for url of current image. Note that variable is in function, hence req to add global var first.
...
function startSearch(termTosearch) {
    ...
    loadJSON(urlforContent, gotContent, 'jsonp'); //to load search results
};
